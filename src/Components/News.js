...
const News = (props) => {
  ...
  const updateNews = async () => {
    props.setProgress(0);
    let url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=66617bb79ca0460288f5945da7f59b77&page=${page}&pageSize=${props.pageSize}`;
    setLoading(true);
  ...
  const fetchMoreData = async () => {
    let url = `https://newsapi.org/v2/top-headlines?country=${
      props.country
    }&category=${props.category}&apiKey=66617bb79ca0460288f5945da7f59b77&page=${
      page + 1
    }&pageSize=${props.pageSize}`;
    setPage(page + 1);
    setLoading(true);
